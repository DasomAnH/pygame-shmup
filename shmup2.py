...
# https://opengameart.org - Art from Kenney.nl
...
# game_folder = os.path.dirname(__file__)  # where is this file is
...
clock = pygame.time.Clock()  # keep track the time
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if keystate[pygame.K_LEFT]:  # key board change
            self.speedx = -8  # make speed
...
bullet_img = pygame.image.load(path.join(img_dir, 'fire12.png')).convert()
meteor_images = []
meteor_list = ['meteorGrey_tiny2.png', 'meteorGrey_small2.png', 'meteorGrey_med1.png',
               'meteorBrown_tiny1.png', 'meteorBrown_big4.png', 'meteorBrown_big2.png']
...
shield_sound = pygame.mixer.Sound(path.join(snd_dir, 'shoot.wav'))
power_sound = pygame.mixer.Sound(path.join(snd_dir, 'shoot.wav'))
expl_sounds = []
